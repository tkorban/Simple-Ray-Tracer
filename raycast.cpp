...
Point chessPoint = {0, 3, 0};
Vector chessBoardNormal = {0, 15, 4};

//matrial properties
float ambient_black[3] = {0, 0, 0};
float ambient_white[3] = {1, 1, 1};
float diffuse_black[3] = {0,0,0};
float diffuse_white[3] = {1,1,1};
float specular_black[3] = {0,0,0};
float specular_white[3] = {1,1,1};
float shineness = 1;
